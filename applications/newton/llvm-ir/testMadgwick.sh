...
if [[ "$ALGO" != "MadgwickAHRS" && "$ALGO" != "MahonyAHRS" && "$ALGO" != "sensfusion6" ]]; then
    echo "Error: Unknown algorithm '$ALGO'. Please use 'MadgwickAHRS', 'MahonyAHRS', or 'sensfusion6'."
    exit 1
fi
...
clang -g -O0 -Xclang -disable-O0-optnone -S -emit-llvm -Wall -Wextra \
