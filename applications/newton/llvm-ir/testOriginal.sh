...
clang $HOME/CoSense/applications/newton/llvm-ir/c-files/test_MadgwickAHRS.c -D FP_DATA_TYPE -no-pie -L$HOME/CoSense/applications/newton/llvm-ir -lout -O3 -Os -g -fno-builtin -o $HOME/CoSense/applications/newton/llvm-ir/main_out -lm
