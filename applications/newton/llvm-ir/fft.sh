...
clang -g0 -O0 -Xclang   -disable-O0-optnone -S -emit-llvm -Wall -Wextra  -o $HOME/CoSense/applications/newton/llvm-ir/fft.ll $HOME/CoSense/applications/newton/llvm-ir/c-files/fft.c


# Step 4: Optimize the generated LLVM IR file
opt $HOME/CoSense/applications/newton/llvm-ir/fft.ll   -S -o $HOME/CoSense/applications/newton/llvm-ir/out.ll
#opt $HOME/CoSense/applications/newton/llvm-ir/fft.ll  -O3 -Os -S -o $HOME/CoSense/applications/newton/llvm-ir/out.ll
