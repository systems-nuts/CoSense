...
clang -g0 -O0 -Xclang   -disable-O0-optnone -S -emit-llvm -Wall -Wextra  -o $HOME/CoSense/applications/newton/llvm-ir/Kalman.ll $HOME/CoSense/applications/newton/llvm-ir/c-files/Kalman.cpp
clang -g0 -O0 -Xclang   -disable-O0-optnone -S -emit-llvm -Wall -Wextra  -o $HOME/CoSense/applications/newton/llvm-ir/lu.ll $HOME/CoSense/applications/newton/llvm-ir/c-files/lu_openmp.c

# Step 4: Optimize the generated LLVM IR file
opt $HOME/CoSense/applications/newton/llvm-ir/Kalman.ll   -S -o $HOME/CoSense/applications/newton/llvm-ir/out.ll
#opt $HOME/CoSense/applications/newton/llvm-ir/Kalman.ll  -O3 -Os -S -o $HOME/CoSense/applications/newton/llvm-ir/out.ll
