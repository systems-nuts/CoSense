...
//	if (recip)
//	{
//		int32_t int_halfx = fixmul(0.5 * FRAC_BASE, x);
//		float	fp_y	  = (float)x / FRAC_BASE;
//		long	i	  = *(long *)&fp_y;
//		i		  = 0x5f3759df - (i >> 1);
//		fp_y		  = *(float *)&i;
//		int32_t int_y	  = fp_y * FRAC_BASE;
//		int_y		  = fixmul(int_y, ((int32_t)(1.5f * FRAC_BASE) - (fixmul(fixmul(int_halfx, int_y), int_y))));
//		return int_y;
//	}
//	else
//	{
		   ...
		   int32_t * q0_ptr, int32_t * q1_ptr, int32_t * q2_ptr, int32_t * q3_ptr)
{
	...
	qDot1 = (-fixmul(q1, gx) - fixmul(q2, gy) - fixmul(q3, gz)) / 2;
	qDot2 = (fixmul(q0, gx) + fixmul(q2, gz) - fixmul(q3, gy)) / 2;
	qDot3 = (fixmul(q0, gy) - fixmul(q1, gz) + fixmul(q3, gx)) / 2;
	qDot4 = (fixmul(q0, gz) + fixmul(q1, gy) - fixmul(q2, gx)) / 2;
	...
	if (!((ax == 0x0) && (ay == 0x0) && (az == 0x0)))
	{
		...
		recipNorm = invSqrt(fixmul(ax, ax) + fixmul(ay, ay) + fixmul(az, az));
		//        printf("1: %f\n", (double)recipNorm/FRAC_BASE);
		ax = fixmul(ax, recipNorm);
		ay = fixmul(ay, recipNorm);
		az = fixmul(az, recipNorm);


		// Normalise magnetometer measurement
		recipNorm = invSqrt(fixmul(mx, mx) + fixmul(my, my) + fixmul(mz, mz));
		mx	  = fixmul(mx, recipNorm);
		my	  = fixmul(my, recipNorm);
		mz	  = fixmul(mz, recipNorm);


		// Auxiliary variables to avoid repeated arithmetic
		_2q0mx = 2 * fixmul(q0, mx);
		_2q0my = 2 * fixmul(q0, my);
		_2q0mz = 2 * fixmul(q0, mz);
		_2q1mx = 2 * fixmul(q1, mx);
		_2q0   = 2 * q0;
		_2q1   = 2 * q1;
		_2q2   = 2 * q2;
		_2q3   = 2 * q3;
		_2q0q2 = 2 * fixmul(q0, q2);
		_2q2q3 = 2 * fixmul(q2, q3);
		q0q0   = fixmul(q0, q0);
		q0q1   = fixmul(q0, q1);
		q0q2   = fixmul(q0, q2);
		q0q3   = fixmul(q0, q3);
		...
		hx   = fixmul(mx, q0q0) - fixmul(_2q0my, q3) + fixmul(_2q0mz, q2) + fixmul(mx, q1q1) + fixmul(fixmul(_2q1, my), q2) + fixmul(fixmul(_2q1, mz), q3) - fixmul(mx, q2q2) - fixmul(mx, q3q3);
		hy   = fixmul(_2q0mx, q3) + fixmul(my, q0q0) - fixmul(_2q0mz, q1) + fixmul(_2q1mx, q2) - fixmul(my, q1q1) + fixmul(my, q2q2) + fixmul(fixmul(_2q2, mz), q3) - fixmul(my, q3q3);
		_2bx = fixsqrt(fixmul(hx, hx) + fixmul(hy, hy));
		_2bz = -fixmul(_2q0mx, q2) + fixmul(_2q0my, q1) + fixmul(mz, q0q0) + fixmul(_2q1mx, q3) - fixmul(mz, q1q1) + fixmul(fixmul(_2q2, my), q3) - fixmul(mz, q2q2) + fixmul(mz, q3q3);
		_4bx = 2 * _2bx;
		_4bz = 2 * _2bz;


		// Gradient decent algorithm corrective step
		s0 = -fixmul(_2q2, (2 * q1q3 - _2q0q2 - ax)) + fixmul(_2q1, (2 * q0q1 + _2q2q3 - ay)) - fixmul(fixmul(_2bz, q2), (fixmul(_2bx, (DEC2FRAC(0.5) - q2q2 - q3q3)) + fixmul(_2bz, (q1q3 - q0q2)) - mx)) + fixmul((-fixmul(_2bx, q3) + fixmul(_2bz, q1)), (fixmul(_2bx, (q1q2 - q0q3)) + fixmul(_2bz, (q0q1 + q2q3)) - my)) + fixmul(fixmul(_2bx, q2), (fixmul(_2bx, (q0q2 + q1q3)) + fixmul(_2bz, (DEC2FRAC(0.5) - q1q1 - q2q2)) - mz));

		s1 = fixmul(_2q3, (2 * q1q3 - _2q0q2 - ax)) + fixmul(_2q0, (2 * q0q1 + _2q2q3 - ay)) - 4 * fixmul(q1, (FRAC_BASE - 2 * q1q1 - 2 * q2q2 - az)) + fixmul(fixmul(_2bz, q3), (fixmul(_2bx, (DEC2FRAC(0.5) - q2q2 - q3q3)) + fixmul(_2bz, (q1q3 - q0q2)) - mx)) + fixmul(fixmul(_2bx, q2) + fixmul(_2bz, q0), (fixmul(_2bx, (q1q2 - q0q3)) + fixmul(_2bz, (q0q1 + q2q3)) - my)) + fixmul(fixmul(_2bx, q3) - fixmul(_4bz, q1), (fixmul(_2bx, (q0q2 + q1q3)) + fixmul(_2bz, (DEC2FRAC(0.5) - q1q1 - q2q2)) - mz));



		s2 = -fixmul(_2q0, (2 * q1q3 - _2q0q2 - ax)) + fixmul(_2q3, (2 * q0q1 + _2q2q3 - ay)) - 4 * fixmul(q2, (FRAC_BASE - 2 * q1q1 - 2 * q2q2 - az)) + fixmul((-fixmul(_4bx, q2) - fixmul(_2bz, q0)), (fixmul(_2bx, (DEC2FRAC(0.5) - q2q2 - q3q3)) + fixmul(_2bz, (q1q3 - q0q2)) - mx)) + fixmul((fixmul(_2bx, q1) + fixmul(_2bz, q3)), (fixmul(_2bx, (q1q2 - q0q3)) + fixmul(_2bz, (q0q1 + q2q3)) - my)) + fixmul((fixmul(_2bx, q0) - fixmul(_4bz, q2)), (fixmul(_2bx, (q0q2 + q1q3)) + fixmul(_2bz, (DEC2FRAC(0.5) - q1q1 - q2q2)) - mz));

		s3 = fixmul(_2q1, (2 * q1q3 - _2q0q2 - ax)) + fixmul(_2q2, (2 * q0q1 + _2q2q3 - ay)) + fixmul((-fixmul(_4bx, q3) + fixmul(_2bz, q1)), (fixmul(_2bx, (DEC2FRAC(0.5) - q2q2 - q3q3)) + fixmul(_2bz, (q1q3 - q0q2)) - mx)) + fixmul((-fixmul(_2bx, q0) + fixmul(_2bz, q2)), (fixmul(_2bx, (q1q2 - q0q3)) + fixmul(_2bz, (q0q1 + q2q3)) - my)) + fixmul(fixmul(_2bx, q1), (fixmul(_2bx, (q0q2 + q1q3)) + fixmul(_2bz, (DEC2FRAC(0.5) - q1q1 - q2q2)) - mz));

		/* 2nd iter normalizaton */
//		recipNorm = invSqrt(fixmul(s0, s0) + fixmul(s1, s1) + fixmul(s2, s2) + fixmul(s3, s3));  // normalise step magnitude
//		s0	  = fixmul(s0, recipNorm);
//		s1	  = fixmul(s1, recipNorm);
//		s2	  = fixmul(s2, recipNorm);
//		s3	  = fixmul(s3, recipNorm);

		// Apply feedback step
		qDot1 -= fixmul(beta, s0);
		qDot2 -= fixmul(beta, s1);
		qDot3 -= fixmul(beta, s2);
		qDot4 -= fixmul(beta, s3);
	}
	...
	recipNorm = invSqrt(fixmul(q0, q0) + fixmul(q1, q1) + fixmul(q2, q2) + fixmul(q3, q3));
	...
	q0	= fixmul(q0, recipNorm);
	q1	= fixmul(q1, recipNorm);
	q2	= fixmul(q2, recipNorm);
	q3	= fixmul(q3, recipNorm);
	*q0_ptr = q0;
	*q1_ptr = q1;
	*q2_ptr = q2;
	*q3_ptr = q3;
		      ...
		      int32_t * q0_ptr, int32_t * q1_ptr, int32_t * q2_ptr, int32_t * q3_ptr)
{
	...
	if (!((ax == 0x0) && (ay == 0x0) && (az == 0x0)))
	{
		...
		// Gradient decent algorithm corrective step
		s0	  = fixmul(_4q0, q2q2) + fixmul(_2q2, ax) + fixmul(_4q0, q1q1) - fixmul(_2q1, ay);
		s1	  = fixmul(_4q1, q3q3) - fixmul(_2q3, ax) + 4 * fixmul(q0q0, q1) - fixmul(_2q0, ay) - _4q1 + fixmul(_8q1, q1q1) + fixmul(_8q1, q2q2) + fixmul(_4q1, az);
		s2	  = 4 * fixmul(q0q0, q2) + fixmul(_2q0, ax) + fixmul(_4q2, q3q3) - fixmul(_2q3, ay) - _4q2 + fixmul(_8q2, q1q1) + fixmul(_8q2, q2q2) + fixmul(_4q2, az);
		s3	  = 4 * fixmul(q1q1, q3) - fixmul(_2q1, ax) + 4 * fixmul(q2q2, q3) - fixmul(_2q2, ay);
		recipNorm = invSqrt(fixmul(s0, s0) + fixmul(s1, s1) + fixmul(s2, s2) + fixmul(s3, s3));  // normalise step magnitude
		s0	  = fixmul(s0, recipNorm);
		s1	  = fixmul(s1, recipNorm);
		s2	  = fixmul(s2, recipNorm);
