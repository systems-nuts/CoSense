...
// volatile bmx055xAcceleration	q0 = FRAC_BASE, q1 = 0x0, q2 = 0x0, q3 = 0x0;	// quaternion of sensor frame relative to auxiliary frame

volatile bmx055xAcceleration q0 = 0.64306622f * FRAC_BASE, q1 = 0.02828862f * FRAC_BASE,
			     q2 = -0.00567953f * FRAC_BASE, q3 = -0.76526684f * FRAC_BASE;
